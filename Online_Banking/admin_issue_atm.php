...
$result = mysqli_query($connection, "SELECT * FROM atm_card WHERE atm_status='Pending'");
	   
?>
<!DOCTYPE html>
<html>
	<head>
		<title>Online Banking System | Issue ATM Card</title>
	...
	<body>
		...
		<div class="atm_issue_table">
			<div class="container">
				...
				<form action="admin_process_atm.php" method="post">
						...
						<tbody>
							...
							error_reporting(0);
                       			while($rws=  mysqli_fetch_assoc($result)){
		                            ...
		                            echo "<td>".$rws['atm_status']."</td>";		                            
		                            echo "</tr>";
                        		}
                        	?>
                        	<tr><td colspan="4"><center><input type="submit" name="atmsubmit" value="Approve" class="BTN1"></center></td></tr>
						</tbody>
					</table>
				</form>
			</div>
